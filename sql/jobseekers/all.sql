...
CREATE TABLE IF NOT EXISTS `resume_basic` (
  ...
  `phone` varchar(11) DEFAULT NULL COMMENT '联系号码',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='简历_教育经历' AUTO_INCREMENT=21 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='简历_求职意向' AUTO_INCREMENT=124 ;
