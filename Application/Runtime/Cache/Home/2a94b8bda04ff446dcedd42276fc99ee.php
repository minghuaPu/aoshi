...
<head>
    ...
    <!--bootstrap-->
    <link rel="stylesheet" href="/aoshi/aoshi/Public/libs/bootstrap/css/bootstrap.css">
    <link rel="stylesheet" href="/aoshi/aoshi/Public/css/normalize.css">
    <!--style-->
    <link rel="stylesheet" href="/aoshi/aoshi/Public/css/base.css">
    <!--[if lt IE 9]>
    <script src="/aoshi/aoshi/Public/libs/html5shiv/html5shiv.min.js"></script>
    <script src="/aoshi/aoshi/Public/libs/respond/respond.min.js"></script>
    <![endif]-->
    <!--owlcarousel-->
    <link rel="stylesheet" href="/aoshi/aoshi/Public/libs/owlcarousel/assets/owl.carousel.min.css">
    <!--<link rel="stylesheet" href="/aoshi/aoshi/Public/libs/owlcarousel/assets/owl.theme.default.css">-->
    <link rel="stylesheet" href="/aoshi/aoshi/Public/css/animate.min.css">
    <title>前端首页</title>
</head>
<body>
<!--header-->
...
<section class="chat">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <img class="line" src="/aoshi/aoshi/Public/images/figure-line.png" alt="..">
            </div>
            <div class="col-md-12">
                <p class="brand-defined">BRAND<br>职信道</p>
            </div>
            <div class="col-md-12">
                <img class="phone" src="/aoshi/aoshi/Public/images/figure-phone-1.png" alt="..">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-1 col-md-5">
                <div class="img-wrap">
                    <p>TOM</p>
                    <img class="chat-wrap" src="/aoshi/aoshi/Public/images/download-phone.png" alt="...">
                    <div class="list-wrap">
                        <img src="/aoshi/aoshi/Public/images/chat-list.png" alt="..." class="chat-list wow animated fadeInUp">
                    </div>

                    <img src="/aoshi/aoshi/Public/images/chat-tip.png" alt="..." class="chat-tip wow animated fadeInUp">
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="comp-img-wrap">
                <img src="/aoshi/aoshi/Public/images/figure-computer.png" alt="...">
            </div>
            <div class="logo-wrap">
                <ul class="figure-logo">
                    <li class="logo1">
                        <img src="/aoshi/aoshi/Public/Picture/logo-didi.png" alt="...">
                    </li>
                    <li class="logo2">
                        <img src="/aoshi/aoshi/Public/Picture/logo-baidu.png" alt="...">
                    </li>
                    <li class="logo3">
                        <img src="/aoshi/aoshi/Public/Picture/logo-meituan.png" alt="...">
                    </li>
                    <li class="logo4">
                        <img src="/aoshi/aoshi/Public/Picture/logo-jd.png" alt="...">
                    </li>
                    <li class="logo5">
                        <img src="/aoshi/aoshi/Public/Picture/logo-ali.png" alt="...">
                    </li>
                    <li class="logo6">
                        <img src="/aoshi/aoshi/Public/Picture/logo-tencent.png" alt="...">
                    </li>
                </ul>
            </div>
...
<section id="pay">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="img-wrap">
                    <img src="/aoshi/aoshi/Public/images/figure-phone-3.png" alt="...">
                </div>
                <ul class="cards-list">
...
<section class="carousel">
    ...
    <div class="owl-carousel">
        <div class="owl-item"><img src="/aoshi/aoshi/Public/Picture/c-1.png"></div>
        <div class="owl-item"><img src="/aoshi/aoshi/Public/Picture/c-2.png"></div>
        <div class="owl-item"><img src="/aoshi/aoshi/Public/Picture/c-3.png"></div>
        <div class="owl-item"><img src="/aoshi/aoshi/Public/Picture/c-4.png"></div>
        <div class="owl-item"><img src="/aoshi/aoshi/Public/Picture/c-5.png"></div>
        <div class="owl-item"><img src="/aoshi/aoshi/Public/Picture/c-6.png"></div>
        <div class="owl-item"><img src="/aoshi/aoshi/Public/Picture/c-7.png"></div>
        <div class="owl-item"><img src="/aoshi/aoshi/Public/Picture/c-8.png"></div>
        <div class="owl-item"><img src="/aoshi/aoshi/Public/Picture/c-9.png"></div>
        <div class="owl-item"><img src="/aoshi/aoshi/Public/Picture/c-10.png"></div>
        <div class="owl-item"><img src="/aoshi/aoshi/Public/Picture/c-11.png"></div>
        <div class="owl-item"><img src="/aoshi/aoshi/Public/Picture/c-12.png"></div>
        <div class="owl-nav">
...
<!--footer-->
<script src="/aoshi/aoshi/Public/libs/jquery/jquery.min.js"></script>
<script src="/aoshi/aoshi/Public/js/wow.min.js"></script>
<script src="/aoshi/aoshi/Public/libs/bootstrap/js/bootstrap.min.js"></script>
<script src="/aoshi/aoshi/Public/libs/owlcarousel/owl.carousel.min.js"></script>
<script src="/aoshi/aoshi/Public/js/base.js"></script>
</body>
</html>