...
<html>
	...
	<body>
		...
		<!--简历-->
		<section id="resume" class="container" ng-app="myResume" ng-controller="resume">
			<!--简历信息-->
			<article class="resume-inner">
				...
				<section id="user-info" ng-controller="userinfo">
					...
					<form id="user-info-form" ng-show="user_info_form">
						<fieldset>
							<label>姓名</label>
							<input class="input-text" ng-model="user_info_form.name">
						</fieldset>
						<fieldset>
							<label>介绍</label>
							<input class="input-text" ng-model="user_info_form.intro">
						</fieldset>
						<fieldset>
							<label>性别</label>
							<select class="input-text" ng-model="user_info_form.sex">
								<option>男</option>
								<option>女</option>
							</select>
						</fieldset>
						<fieldset>
							<label>出生年份</label>
							<select class="input-text" ng-model="user_info_form.birth">
								<option>00后</option>
								<option>90后</option>
								<option>80后</option>
								<option>其他</option>
						...
						<fieldset>
							<label>学历</label>
							<select class="input-text" ng-model="user_info_form.xl">
								<option>大专</option>
								<option>本科</option>
								<option>硕士</option>
								<option>博士</option>
						...
						<fieldset>
							<label>工作年限</label>
							<select class="input-text" ng-model="user_info_form.gzjy">
								<option>应届毕业生</option>
								<option>1-3年</option>
								<option>3-5年</option>
								<option>5-10年</option>
						...
						<fieldset>
							<label>所在城市</label>
							<select class="input-text" ng-model="user_info_form.city">
								<option>北京</option>
								<option>上海</option>
								<option>广州</option>
								<option>深圳</option>
						...
						<fieldset>
							<label>手机号码</label>
							<input class="input-text" ng-model="user_info_form.phone">
						</fieldset>
						<fieldset>
							<label>联系邮箱</label>
							<input class="input-text" ng-model="user_info_form.email">
						</fieldset>
						<fieldset>
				...
				<section ng-controller="jobexp">
					<h5 class="resume-title"><span>工作经历</span><a class="edit" href="javascript:;">添加 {{ zfc }}</a></h5>
					<ul class="list">
					  <li ng-repeat="item in exp_list">
					  	<a class="del" href="javascript:;" data-id="{{ item.jid }}">删除</a>
				...
				<section id="edu-exp" ng-controller="eduexp">
					...
					<form id="edu-exp-form" ng-show="edu_exp_form">
						<fieldset>
							<label>学校名称</label>
							<input class="input-text" ng-model="edu_exp_form.name">
						</fieldset>
						<fieldset>
							<label>所学专业</label>
							<input class="input-text" ng-model="edu_exp_form.major">
						</fieldset>
						<fieldset>
							<label>学历</label>
							<select class="input-text" ng-model="edu_exp_form.xl">
								<option>大专</option>
								<option>本科</option>
								<option>硕士</option>
								<option>博士</option>
						...
						<fieldset>
							<label>毕业时间</label>
							<select class="input-text" ng-model="edu_exp_form.grad">
								<option>2017</option>
								<option>2016</option>
								<option>2015</option>
								<option>2014</option>
