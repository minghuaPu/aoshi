...
<head>
	<title></title>
	<link rel="stylesheet" type="text/css" href="/project/aoshi/Public/css/bootstrap-3.3.0/css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="/project/aoshi/Public/css/admin/common.css">
	<script type="text/javascript" src="/project/aoshi/Public/js/jquery.1.11.1.min.js"></script>
	<script type="text/javascript">
		var SITE_URL="/project/aoshi/index.php/Admin";
	</script>
</head>
<body>


<link rel="stylesheet" type="text/css" href="/project/aoshi/Public/css/admin/login.css">
...
<script type="text/javascript" src='/project/aoshi/Public/js/admin/login.js'>   </script>
</body>
</html>