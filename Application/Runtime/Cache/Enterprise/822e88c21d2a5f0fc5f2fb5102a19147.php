...
<head>
    ...
    <link rel="stylesheet" href="/aoshi/Public/css/enterprise/index.css?1">
    <script type="text/javascript" src="/aoshi/Public/js/jquery.1.11.1.min.js"></script>
    <script type="text/javascript" src="/aoshi/Public/libs/bootstrap/js/bootstrap.min.js"></script>

    <script src="/aoshi/Public/js/jobseekers/jquery-3.1.1.min.js"></script><!-- jQuery is required -->
    <link  href="/aoshi/Public/js/jobseekers/cropper.min.css" rel="stylesheet">
    <link  href="/aoshi/Public/js/jobseekers/main.css" rel="stylesheet">
    ...
    <script type="text/javascript">
        var SITE_URL="/aoshi/index.php/Enterprise";
    </script>
</head>
<body>
<div class="body">
    ...
    <div class="nav_bar">
        <!--<img src="/aoshi/Public/Picture/boss-4.png" alt="">-->
        <div class="touxiang">
            <div class="box">
<!--------------------------------------------------------------------------------------------------->
...
<link rel="stylesheet" href="/aoshi/Public/css/enterprise/resume.css?3">
<div class="container">
    <div class="content">
        <form action="">
...
<script src="/aoshi/Public/js/enterprise/index.js?2"></script>
<script src="/aoshi/Public/js/enterprise/search.js"></script>