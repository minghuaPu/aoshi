...
<head>
    ...
    <link rel="stylesheet" href="/aoshi/aoshi/Public/css/enterprise/index.css?3">
        ...
        <div class="nav_item">
            ...
            <div class="item seeker">
                <div
                    ...
                    <p>牛人</p>
                    <span
                    <!--<?php if(ACTION_NAME== visit): ?>class="i_open"<?php endif; ?>-->
                    <?php if(ACTION_NAME== resume): ?>class="i_open"<?php endif; ?>
                    class="i_close"></span>
                </div>
...
<link rel="stylesheet" href="/aoshi/aoshi/Public/css/enterprise/resume.css?5">
<div class="container">
    <div class="content">
        <form action="">
        ...
        <div class="tit_box row">
            ...
            <div class="col-md-3">曾发布的简历职位</div>
            <div class="col-md-1">性别</div>
            <div class="col-md-1">薪资</div>
            <div class="col-md-1">学历</div>
            <div class="col-md-2">居住地方</div>
            <div class="col-md-2">工作经验</div>
            <div class="col-md-1">详情</div>
        </div>
        <table class="table row">
            <tr>
                <th class="col-md-1">陈小明</th>
                <th class="col-md-3">Web前端开发工程师</th>
                <th class="col-md-1">男</th>
                <th class="col-md-1">￥5555</th>
                <th class="col-md-1">本科大学</th>
                <th class="col-md-2">广州市天河区</th>
                <th class="col-md-2">3年后台开发</th>
                <th class="col-md-1 state"><input type="button" value="点击查看" class="btn-default"></th>
            </tr>
        </table>
    </div>
</div>
